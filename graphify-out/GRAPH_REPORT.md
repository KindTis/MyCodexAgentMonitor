...
## Corpus Check
- 31 files · ~699,216 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 347 nodes · 514 edges · 22 communities (20 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5c316c15`
...
2. `로컬 Codex 실시간 현황판 설계` - 16 edges
3. `AppServerClient` - 15 edges
...
8. `toIso()` - 9 edges
9. `App()` - 9 edges
10. `로컬 Codex 실시간 현황판 구현 항목 매핑` - 9 edges
...
### Community 1 - "디자인 QA"
Cohesion: 0.13
Nodes (33): ACTIVE_CHILD_STATUSES, compareValues(), durationInSeconds(), formatDuration(), formatGoalStatus(), formatTokenCount(), formatUtcTime(), getDisplayedDuration() (+25 more)
...
Cohesion: 0.09
Nodes (34): activityKind(), addDuration(), applyEventRecord(), applyResponseRecord(), applyTurnItems(), applyTurnTerminalState(), applyUserMessage(), applyWorkingRecord() (+26 more)
...
## Knowledge Gaps
- **129 isolated node(s):** `RETRY_DELAYS_MS`, `EMPTY_SNAPSHOT`, `PLAN_STATUS`, `SessionReadFailure`, `name` (+124 more)
